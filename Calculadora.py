...
def show_buttons():
    ...
    BZero.place(x=10, y=210)
    BDecimal.place(x=80, y=210)
    Bigual.place(x=150, y=210)
...
Bon = Button(janela, text="ON",bg=co2, fg=co4,font=('Arial 11 bold'), width=6, relief=RAISED, overrelief=RIDGE, command=show_buttons)
Bon.place(x=10, y=35)
BOff = Button(janela, text="OFF",bg=co2, fg=co4,font=('Arial 11 bold'), width=6, relief=RAISED, overrelief=RIDGE, command=toggle_buttons)
BOff.place(x=80, y=35)
